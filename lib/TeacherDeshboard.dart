...
class _TeacherDeshboardState extends State<TeacherDeshboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Teacher Deshboard', ),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            Text('Create Question',textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 19.5,),),
                            SizedBox(height: 12,),
                            Container(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Set Exam',textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,),),
                            SizedBox(height: 12,),
                            Container(
                                padding: EdgeInsets.all(10),
                                decoration: BoxDecoration(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Give Marks',textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,),),
                            SizedBox(height: 12,),
                            Container(
                                padding: EdgeInsets.all(10),
                                decoration: BoxDecoration(
